...
export function Hero() {
  ...
  return (
    <section className="bg-neutral-very-light-gray grid grid-cols-1 grid-rows-[305px_365px] md:grid-cols-12 md:grid-rows-[655px] md:items-center">
      <Container
        ref={ref}
      ...
      >
        <div
          className={`size-full transition-all duration-700 
        ...
        >
          ...
          <p className="text-sm leading-6 text-neutral-grayish-blue md:text-[1rem] md:mt-2 lg:text-[1.1rem] max-w-[500px]">
        ...
        <div className="hidden -translate-x-10 -translate-y-62 size-full md:block">
          <img
            ...
            className={`object-cover object-top-left min-w-[1271px] h-auto 
              transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}
          />
        </div>
